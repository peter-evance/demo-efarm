    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_of_hatching', models.DateField(validators=[django.core.validators.MinValueValidator(datetime.date(2023, 4, 24)), django.core.validators.MaxValueValidator(datetime.date(2023, 6, 19))])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(choices=[('Kuroiler', 'Kuroiler'), ('Rainbow Rooster', 'Rainbow Rooster'), ('Kenbro', 'Kenbro'), ('Indigenous', 'Indigenous'), ('Leghorn', 'Leghorn'), ('Sussex', 'Sussex'), ('Plymouth Rock', 'Plymouth Rock'), ('Rhode Island Red', 'Rhode Island Red'), ('Brahma', 'Brahma'), ('Cornish Cross', 'Cornish Cross'), ('Australorp', 'Australorp'), ('Orpington', 'Orpington'), ('Wyandotte', 'Wyandotte'), ('Silkie', 'Silkie'), ('Cochin', 'Cochin'), ('Easter Egger', 'Easter Egger'), ('Bantam', 'Bantam'), ('Sasso F1', 'Sasso F1'), ('Other', 'Other')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='FlockSource',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('source', models.CharField(choices=[('This Farm', 'This Farm'), ('Ken Chick', 'Ken Chick'), ('Kuku Chick', 'Kuku Chick'), ('Uzima Chicken', 'Uzima Chicken'), ("Kiplel's Farm", 'Kiplels Farm')], max_length=13)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('average_mature_weight_in_kgs', models.DecimalField(decimal_places=2, max_digits=5)),
                ('average_egg_production', models.PositiveIntegerField(null=True)),
                ('maturity_age_in_weeks', models.PositiveIntegerField()),
                ('breed', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='poultry.flockbreed')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='flock',
            name='breed',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='flocks', to='poultry.flockbreed'),
        ),
        migrations.AddField(
            model_name='flock',
            name='current_housing_structure',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='flocks', to='poultry.housingstructure'),
        ),
        migrations.AddField(
            model_name='flock',
            name='source',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='flocks', to='poultry.flocksource'),
        ),
        migrations.CreateModel(
            name='EggCollection',
            fields=[
