...
router.register(
    r"inseminator-records", InseminatorViewset, basename="inseminator-records"
)
...
router.register(
    r"cow-in-pen-movements", CowInPenMovementViewSet, basename="cow-in-pen-movement"
)
router.register(
    r"cow-in-barn-movements", CowInBarnMovementViewSet, basename="cow-in-barn-movement"
)
urlpatterns = [
